...
//					if(!closestAppleMO.getI().equals(jsonInfo.toString())){
//						//closestAppleMO.updateI(jsonInfo.toString());
//                                                
...
//				}
				...
				//closestAppleMO.updateI(""); //couldn't find any nearby apples
                                closest_apple = null;
                                closestAppleMO.setI(closest_apple);
