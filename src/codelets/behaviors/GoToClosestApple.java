...
public class GoToClosestApple extends Codelet {
	...
	public void proc() {
		...
		//String selfInfo= (String) selfInfoMO.getI();
                ...
                //Double hunger = (Double) hungerMO.getI();
		...
		if(closestApple != null)
		{
			...
			try {
				...
				//legsMO2.updateI(message.toString());
                                legsMO2.setI(message.toString());
                                //synchronized(hungerMO){
                                    if (hungerMO != null){// System.out.println("hungerMO está null !!!");
                                        Double h = (Double)hungerMO.getI();
                                        legsMO2.setEvaluation(h);
                                    } 
                                //}
